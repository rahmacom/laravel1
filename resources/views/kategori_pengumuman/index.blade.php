    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn btn-primary" href="{{ route('kategori_pengumuman.create') }}">Add Data</a>
...
@foreach ($kategori_pengumuman as $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-success" href="{{ route('kategori_pengumuman.show', $item->id) }}">view</a>
                                    <a class="btn btn-info" href="{{ route('kategori_pengumuman.edit', $item->id) }}">edit</a>
