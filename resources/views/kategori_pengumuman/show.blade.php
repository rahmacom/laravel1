            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                            ...
                            <label for="create" class="col-md-6 col-form-label text-md-left">{{ $kategori_pengumuman->created_at }}</label>
                    </div>

                    <div class="form-group row">
                            <label for="update" class="col-md-4 col-form-label text-md-left">updated_at</label>
                            <label for="update" class="col-md-6 col-form-label text-md-left">{{ $kategori_pengumuman->updated_at }}</label>
                    </div>
                </div>
            </div>
        </div>
